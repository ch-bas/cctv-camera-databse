# Aqara Camera Hub G5 Pro (Switzerland)

*Also known as: Aqara G5 Pro HomeKit Thread Matter CH/AT*

| Field | Spec |
|-------|------|
| Brand | Aqara |
| Model | Camera Hub G5 Pro (Switzerland) |
| Type | dome |
| Connectivity | ethernet, wifi |
| Resolution | 2.6K 4MP (4MP, 2560×1440) |
| Sensor | 1/1.8" graphene-cooled CMOS |
| Lens | 1× Fixedmm F1.0 |
| Field of view | 133 diagonal° |
...
- 4MP True Color Night Vision F1.0 graphene sensor
...
---
*Auto-generated from aqara-camera-hub-g5-pro-ch.json — do not edit by hand.*
